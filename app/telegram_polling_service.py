...
class TelegramPollingService:
    ...
    async def _process_updates(self, updates: List[Dict[str, Any]]):
        ...
        for update in updates:
            try:
                ...
                logger.info(f"📋 Processing update {update_id}: {update.get('message', {}).get('text', 'No text')}")
    ...
    async def _send_response(self, response: Dict[str, Any]):
        ...
        try:
            ...
            if method == "sendMessage":
                ...
                logger.info(f"📤 Sending message to chat {response.get('chat_id')}")
                ...
                if api_response.status_code == 200:
                    logger.info(f"✅ Message sent successfully to chat {response.get('chat_id')}")
                else:
    ...
    async def send_message(self, chat_id: str, text: str, parse_mode: str = "Markdown") -> bool:
        ...
        try:
            ...
            logger.info(f"📤 Sending direct message to chat {chat_id}")
